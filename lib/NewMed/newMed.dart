...
import 'package:medtrack/NewMed/MedicineTypeForm/medicineType.dart';
import 'package:medtrack/NewMed/MedicineTypeForm/medicineTypeCard.dart';
...
class _NewMedicineState extends State<NewMedicine> {
              ...
              child: Expanded(
                child: Column(
                  children: [
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value!.isEmpty) {
                                  ...
                                  return 'Please Enter Pill Amount.';
                                } else {
                                  return null;
                                }
                              },
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            //medicineTypes[medicineTypes.indexWhere((element) => element.isChoose == true)].name
                    ...
                    // Text(medicineTypes[medicineTypes
  ...
  CollectionReference<Map<String, dynamic>> medicinesCollection =
      FirebaseFirestore.instance.collection('medicines');
  Future<void> createMedicineDate() async {
    User? user = _auth.currentUser;
    try {
      // Create a reference to the user's document within the medicines collection
      DocumentReference<Map<String, dynamic>> userDocumentRef =
          medicinesCollection.doc(user!.email);

      // Create a new date document within the user's document
      DocumentReference<Map<String, dynamic>> dateDocumentRef = userDocumentRef
          .collection('dates')
          .doc(DateFormat("dd.MM.yy").format(setDate));

      DocumentReference<Map<String, dynamic>> MedDocumentRef =
          dateDocumentRef.collection('medicines').doc();

      // Set the fields for the date document
      await MedDocumentRef.set({
        'pillName': pillName,
